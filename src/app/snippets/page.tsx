      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 text-sm text-gray-400 mb-6 cursor-pointer hover:opacity-0"
          >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-200 to-gray-500 text-transparent bg-clip-text mb-6"
          >
